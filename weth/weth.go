...
func (_Token *TokenTransactor) Withdraw(opts *bind.TransactOpts, wad *big.Int) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "withdraw", wad)
}
...
func (_Token *TokenSession) Withdraw(wad *big.Int) (*types.Transaction, error) {
	return _Token.Contract.Withdraw(&_Token.TransactOpts, wad)
}
...
func (_Token *TokenFilterer) FilterDeposit(opts *bind.FilterOpts, dst []common.Address) (*TokenDepositIterator, error) {
	...
	logs, sub, err := _Token.contract.FilterLogs(opts, "Deposit", dstRule)
	if err != nil {
		return nil, err
	}
...
func (_Token *TokenFilterer) WatchDeposit(opts *bind.WatchOpts, sink chan<- *TokenDeposit, dst []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Token.contract.WatchLogs(opts, "Deposit", dstRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
func (_Token *TokenFilterer) FilterWithdrawal(opts *bind.FilterOpts, src []common.Address) (*TokenWithdrawalIterator, error) {
	...
	logs, sub, err := _Token.contract.FilterLogs(opts, "Withdrawal", srcRule)
	if err != nil {
		return nil, err
	}
	return &TokenWithdrawalIterator{contract: _Token.contract, event: "Withdrawal", logs: logs, sub: sub}, nil
}
...
func (_Token *TokenFilterer) WatchWithdrawal(opts *bind.WatchOpts, sink chan<- *TokenWithdrawal, src []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Token.contract.WatchLogs(opts, "Withdrawal", srcRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(TokenWithdrawal)
				if err := _Token.contract.UnpackLog(event, "Withdrawal", log); err != nil {
					return err
				}
				event.Raw = log
